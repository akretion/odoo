...
class procurement_order(osv.osv):
    ...
    def _procure_confirm(self, cr, uid, ids=None, use_new_cursor=False, context=None):
        ...
        try:
            ...
            if not ids:
                ids = procurement_obj.search(cr, uid, [('state', '=', 'exception'), ('date_planned', '>', '2016-01-01')], order="date_planned")
            for id in ids:
    ...
    def create_automatic_op(self, cr, uid, context=None):
        ...
        products_ids = product_obj.search(cr, uid, [('procure_method', '=', 'make_to_stock')], order='id', context=context)
